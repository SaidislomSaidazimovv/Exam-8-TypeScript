    ...
    <header className="bg-white sticky top-0 z-50 shadow-sm">
      <div className="bg-gray-100 py-2 text-sm">
        <div className="container mx-auto flex justify-between items-center px-4">
          <span className="text-gray-600">Бесплатная доставка!</span>
          <div className="flex space-x-4 text-gray-600">
            <Link to="/promo" className="text-red-500">Акции</Link>
            <Link to="/shipping" className="hover:text-blue-800">Доставка и Оплата</Link>
            <Link to="/about" className="hover:text-blue-800">О магазине</Link>
          </div>
          <Link to="/beauty-club" className="hover:text-blue-800">
      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <button onClick={openSearchModal} className="text-gray-700 hover:text-gray-900 transition-colors duration-300">
          <AiOutlineSearch className="w-6 h-6" />
        </button>

        <Link to="/" className="text-3xl font-bold ml-60 text-black">MAKEUP</Link>
        ...
        <div className="flex items-center space-x-6">
          ...
          <Link to="/profile" className="text-gray-700 hover:text-gray-900 transition-colors duration-300">
            <GrUser className="w-7 h-6" />
          </Link>
          <Link to="/like" className="relative flex items-center text-gray-700 hover:text-red-600 transition-colors duration-300">
            <GrFavorite className="w-7 h-6" />
            <span className="absolute -top-2 -right-2 bg-red-600 text-white rounded-full px-2 py-1 text-xs">{likesCount}</span>
          </Link>
          <Link to="/cart" className="relative flex items-center text-gray-700 hover:text-blue-600 transition-colors duration-300">
            <MdOutlineShoppingCart className="w-7 h-6 mr-2" />
            <span className="absolute -top-2 -right-1 bg-blue-600 text-white rounded-full px-2 py-1 text-xs">{cartItemsCount}</span>
          </Link>
        </div>
      </div>
